        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="flex flex-wrap gap-3">
              <a href="/app" className="group inline-flex items-center gap-2 px-7 py-3.5 bg-red-600 text-white font-semibold rounded-xl hover:bg-red-500 transition-all shadow-lg shadow-red-600/20">
