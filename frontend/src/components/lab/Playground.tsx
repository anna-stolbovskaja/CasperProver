  ...
  const initialSteps: PipelineStep[] = [
    {
      ...
      action: async () => {
        ...
        const res = await api.registerModel({ model_id: mid, model_hash: genId('hash'), verifier_contract: '06d69182b13c4d041613fe7e6e0805cdb06f099eff4291b40154d78cc0c79b66', metadata: { type: 'decision-box', version: '1.0' } });
