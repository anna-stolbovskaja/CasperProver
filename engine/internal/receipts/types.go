...
// Verdict mirrors decision.Verdict as its canonical string form. Copied
...
// FromDecision maps a decision.Verdict onto the receipts.Verdict string.
func FromDecision(v decision.Verdict) Verdict {
	switch v {
	case decision.VerdictApprove:
		return VerdictApprove
	case decision.VerdictAbstain:
...
type DecisionReceipt struct {
	...
	// see decision.Decision.ID). Downstream verifiers use this to
	...
	// ModelID names the model version consulted for this decision. The
